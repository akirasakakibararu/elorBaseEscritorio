...
public class ConsultasAlumno {
	...
	public static List<Object[]> mostrar_horario_alumno(int id) {
		...
		String hql = "SELECT h.hora, h.dia, h.aula, a.nombre, a.idAsignatura, p.nombre, p.apellidos "
				...
				+ "ON a.idAsignatura = h.idAsignatura " + "WHERE al.idAlumno = :idAlumno";
	...
	public static List<Object[]> mostrar_datos_alumno(int id) {
		List<Object[]> results = null;
		...
		String hql = "select a.idAlumno, a.email, a.dni, a.nombre, a.apellidos, a.telefono1, a.telefono2, "
		           + "m.curso, m.fecha, cf.idCiclo "
		           + "from Matriculacion m "
		           + "join Alumno a on m.idAlumno = a.idAlumno "
		           + "join Cicloformativo cf on m.idCiclo = cf.idCiclo "
